...
const std::vector<std::string> CORRECT_COMMAND_BODIES = { "signup", "login", "films", "money", 
														...
														"notifications",  "notifications read", "logout" };
...
const std::vector<std::string> POST_COMMANDS = { "signup", "login", "films", "money", 
												 "replies", "followers", "buy", "rate", 
												 "comments", "put_films", "delete_films", 
												 "delete_comments", "logout" };
